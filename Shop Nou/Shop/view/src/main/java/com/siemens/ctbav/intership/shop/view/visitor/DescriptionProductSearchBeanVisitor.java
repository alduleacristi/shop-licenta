...
@ManagedBean(name = "productDescriptionSearchVisitor")
@ViewScoped
@URLMappings(mappings = { @URLMapping(id = "productSearchDescriptionVisitor", pattern = "/client/productSearchDescription/#{productDescriptionSearchClient.id}", viewId = "/client/productSearchDescription.xhtml") })
public class DescriptionProductSearchBeanVisitor implements Serializable {
